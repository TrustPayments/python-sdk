...
class ChargeFlowLevelServiceApi:
    ...
    def send_message_with_http_info(self, space_id, id, **kwargs):
        ...
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `send_message`")
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `send_message`")
        ...
        return self.api_client.call_api(
            '/charge-flow-level/sendMessage', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
