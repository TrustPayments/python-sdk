...
class SubscriptionAffiliateServiceApi:
    ...
    def count_with_http_info(self, space_id, **kwargs):
        ...
        return self.api_client.call_api(
            '/subscription-affiliate/count', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_with_http_info(self, space_id, entity, **kwargs):
        ...
        return self.api_client.call_api(
            '/subscription-affiliate/create', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_with_http_info(self, space_id, id, **kwargs):
        ...
        return self.api_client.call_api(
            '/subscription-affiliate/delete', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_with_http_info(self, space_id, id, **kwargs):
        ...
        return self.api_client.call_api(
            '/subscription-affiliate/read', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_with_http_info(self, space_id, query, **kwargs):
        ...
        return self.api_client.call_api(
            '/subscription-affiliate/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_with_http_info(self, space_id, entity, **kwargs):
        ...
        return self.api_client.call_api(
            '/subscription-affiliate/update', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
