...
class DeliveryIndicationServiceApi:
    ...
    def count_with_http_info(self, space_id, **kwargs):
        ...
        return self.api_client.call_api(
            '/delivery-indication/count', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def mark_as_not_suitable_with_http_info(self, space_id, delivery_indication_id, **kwargs):
        ...
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `mark_as_not_suitable`")
        # verify the required parameter 'delivery_indication_id' is set
        if ('delivery_indication_id' not in params or
                params['delivery_indication_id'] is None):
            raise ValueError("Missing the required parameter `delivery_indication_id` when calling `mark_as_not_suitable`")
        ...
        body_params = None
        if 'delivery_indication_id' in params:
            body_params = params['delivery_indication_id']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json;charset=utf-8'])
        ...
        return self.api_client.call_api(
            '/delivery-indication/markAsNotSuitable', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def mark_as_suitable_with_http_info(self, space_id, delivery_indication_id, **kwargs):
        ...
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `mark_as_suitable`")
        # verify the required parameter 'delivery_indication_id' is set
        if ('delivery_indication_id' not in params or
                params['delivery_indication_id'] is None):
            raise ValueError("Missing the required parameter `delivery_indication_id` when calling `mark_as_suitable`")
        ...
        return self.api_client.call_api(
            '/delivery-indication/markAsSuitable', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_with_http_info(self, space_id, query, **kwargs):
        ...
        return self.api_client.call_api(
            '/delivery-indication/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
