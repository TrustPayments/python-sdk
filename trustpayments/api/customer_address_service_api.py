...
class CustomerAddressServiceApi:
    ...
    def select_default_address_with_http_info(self, space_id, id, **kwargs):
        ...
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `select_default_address`")
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `select_default_address`")
        ...
        return self.api_client.call_api(
            '/customer-address/select-default-address', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
